...
\section*{Feedback Ryan}
	\begin{coi}
		...
		\item p 10. Citation: Remove "Elizabeth A."
		...
		\item p 17. A clear statement of the problems of both typical ordinal variable treatments here
		...
		\item p 27. Make a figure and move this to the appendix
		\item 2.4.2. How do you do this blocking? 
		\item p 29. Do this 5000 times, if easy
		\item p 29. Is there any precision difference between the two methods?
