...
```{r Density-Education-Categories-Linear-Predictors, echo=FALSE, fig.width=10, fig.height=6, fig.cap="Distribution of Education Linear Predictor Data Cases. Vertical Lines Are Threshold Cutpoints. No Cases Fall Lower than `12th|HS grad` or Higher than `Master's|Professional`.\\label{DensEducLP}"}
