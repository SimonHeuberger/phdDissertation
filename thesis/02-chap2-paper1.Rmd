...
tab <- stargazer(df.all, 
                 ...
                 header=FALSE,
                 align = TRUE,
                 title = "Blocking on ANES and Ordered Probit Education Categories",
...
names(list.dfs.fac.aov) <- c("T1", "T2", "T3", "T4", "T5")
...
# now to make all of that into tables ... 
