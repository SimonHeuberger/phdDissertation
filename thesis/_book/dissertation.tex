...
\hypertarget{ordmiss-results-acc-ampute}{%
\subsection{\texorpdfstring{With \texttt{ampute()}}{With ampute()}}\label{ordmiss-results-acc-ampute}}
\begin{table}[!htbp] \centering 
...
These results are confirmed when \texttt{ampute()} is run with the options \texttt{bycoases=FALSE} and \texttt{cont=FALSE}, as shown in Table \ref{amp.bycases.old.frame.acc}, and when \texttt{ampute()} is run on the 2016 ANES data, as shown in Table \ref{amp.anes.acc}. It is noticeable, however, that the differences in method performance are somewhat reduced with the ANES data. This is likely due to the increased number of observations in the data.
\begin{table}[!htbp] \centering 
  \caption{Accuracy of Multiple Imputation Methods (ampute with bycases, old framing data)} 
...
\hline \\[-1.8ex] 
\multicolumn{1}{c}{true} & \multicolumn{1}{c}{Dem} & 0.467 & 0 \\ 
\multicolumn{1}{c}{hd.ord} & \multicolumn{1}{c}{Dem} & 0.467 & 0.001 \\ 
\multicolumn{1}{c}{hd.norm.orig} & \multicolumn{1}{c}{Dem} & 0.469 & 0.002 \\ 
\multicolumn{1}{c}{amelia} & \multicolumn{1}{c}{Dem} & 0.467 & 0.0003 \\ 
\multicolumn{1}{c}{mice} & \multicolumn{1}{c}{Dem} & 0.467 & 0.0001 \\ 
\multicolumn{1}{c}{na.omit} & \multicolumn{1}{c}{Dem} & 0.236 & -0.230 \\ 
\multicolumn{1}{c}{true} & \multicolumn{1}{c}{inc} & 3.093 & 0 \\ 
\multicolumn{1}{c}{hd.ord} & \multicolumn{1}{c}{inc} & 3.047 & -0.046 \\ 
\multicolumn{1}{c}{hd.norm.orig} & \multicolumn{1}{c}{inc} & 3.025 & -0.068 \\ 
\multicolumn{1}{c}{amelia} & \multicolumn{1}{c}{inc} & 3.094 & 0.001 \\ 
\multicolumn{1}{c}{mice} & \multicolumn{1}{c}{inc} & 3.097 & 0.005 \\ 
\multicolumn{1}{c}{na.omit} & \multicolumn{1}{c}{inc} & 2.421 & -0.672 \\ 
\multicolumn{1}{c}{true} & \multicolumn{1}{c}{age} & 37.925 & 0 \\ 
\multicolumn{1}{c}{hd.ord} & \multicolumn{1}{c}{age} & 36.506 & -1.419 \\ 
\multicolumn{1}{c}{hd.norm.orig} & \multicolumn{1}{c}{age} & 36.344 & -1.581 \\ 
\multicolumn{1}{c}{amelia} & \multicolumn{1}{c}{age} & 37.929 & 0.004 \\ 
\multicolumn{1}{c}{mice} & \multicolumn{1}{c}{age} & 37.940 & 0.015 \\ 
\multicolumn{1}{c}{na.omit} & \multicolumn{1}{c}{age} & 31.696 & -6.229 \\ 
\multicolumn{1}{c}{true} & \multicolumn{1}{c}{Female} & 0.467 & 0 \\ 
\multicolumn{1}{c}{hd.ord} & \multicolumn{1}{c}{Female} & 0.462 & -0.005 \\ 
\multicolumn{1}{c}{hd.norm.orig} & \multicolumn{1}{c}{Female} & 0.460 & -0.007 \\ 
\multicolumn{1}{c}{amelia} & \multicolumn{1}{c}{Female} & 0.466 & -0.0003 \\ 
\multicolumn{1}{c}{mice} & \multicolumn{1}{c}{Female} & 0.467 & 0 \\ 
\multicolumn{1}{c}{na.omit} & \multicolumn{1}{c}{Female} & 0.217 & -0.250 \\ 
\multicolumn{1}{c}{true} & \multicolumn{1}{c}{interest} & 3.216 & 0 \\ 
\multicolumn{1}{c}{hd.ord} & \multicolumn{1}{c}{interest} & 3.136 & -0.080 \\ 
\multicolumn{1}{c}{hd.norm.orig} & \multicolumn{1}{c}{interest} & 3.122 & -0.094 \\ 
\multicolumn{1}{c}{amelia} & \multicolumn{1}{c}{interest} & 3.215 & -0.001 \\ 
\multicolumn{1}{c}{mice} & \multicolumn{1}{c}{interest} & 3.215 & -0.002 \\ 
\multicolumn{1}{c}{na.omit} & \multicolumn{1}{c}{interest} & 2.728 & -0.488 \\ 
\hline \\[-1.8ex] 
\end{tabular} 
\end{table}
\begin{table}[!htbp] \centering 
  \caption{Accuracy of Multiple Imputation Methods (ampute, ANES)} 
  \label{amp.anes.acc} 
\begin{tabular}{@{\extracolsep{5pt}} D{.}{.}{-3} D{.}{.}{-3} D{.}{.}{-3} D{.}{.}{-3} } 
\\[-1.8ex]\hline 
\hline \\[-1.8ex] 
\multicolumn{1}{c}{Method} & \multicolumn{1}{c}{Variable} & \multicolumn{1}{c}{Value} & \multicolumn{1}{c}{Diff} \\ 
\hline \\[-1.8ex] 
\multicolumn{1}{c}{true} & \multicolumn{1}{c}{Dem} & 0.355 & 0 \\ 
\multicolumn{1}{c}{hd.ord} & \multicolumn{1}{c}{Dem} & 0.355 & 0.0003 \\ 
\multicolumn{1}{c}{hd.norm.orig} & \multicolumn{1}{c}{Dem} & 0.355 & 0.0003 \\ 
\multicolumn{1}{c}{amelia} & \multicolumn{1}{c}{Dem} & 0.355 & 0 \\ 
\multicolumn{1}{c}{mice} & \multicolumn{1}{c}{Dem} & 0.355 & 0 \\ 
\multicolumn{1}{c}{na.omit} & \multicolumn{1}{c}{Dem} & 0.339 & -0.016 \\ 
\multicolumn{1}{c}{true} & \multicolumn{1}{c}{inc} & 15.574 & 0 \\ 
\multicolumn{1}{c}{hd.ord} & \multicolumn{1}{c}{inc} & 15.576 & 0.002 \\ 
\multicolumn{1}{c}{hd.norm.orig} & \multicolumn{1}{c}{inc} & 15.578 & 0.004 \\ 
\multicolumn{1}{c}{amelia} & \multicolumn{1}{c}{inc} & 15.575 & 0.001 \\ 
\multicolumn{1}{c}{mice} & \multicolumn{1}{c}{inc} & 15.575 & 0.002 \\ 
\multicolumn{1}{c}{na.omit} & \multicolumn{1}{c}{inc} & 15.231 & -0.343 \\ 
\multicolumn{1}{c}{true} & \multicolumn{1}{c}{age} & 49.040 & 0 \\ 
\multicolumn{1}{c}{hd.ord} & \multicolumn{1}{c}{age} & 49.008 & -0.032 \\ 
\multicolumn{1}{c}{hd.norm.orig} & \multicolumn{1}{c}{age} & 49.016 & -0.024 \\ 
\multicolumn{1}{c}{amelia} & \multicolumn{1}{c}{age} & 49.038 & -0.002 \\ 
\multicolumn{1}{c}{mice} & \multicolumn{1}{c}{age} & 49.038 & -0.002 \\ 
\multicolumn{1}{c}{na.omit} & \multicolumn{1}{c}{age} & 48.378 & -0.662 \\ 
\multicolumn{1}{c}{true} & \multicolumn{1}{c}{Male} & 0.468 & 0 \\ 
\multicolumn{1}{c}{hd.ord} & \multicolumn{1}{c}{Male} & 0.468 & 0.0002 \\ 
\multicolumn{1}{c}{hd.norm.orig} & \multicolumn{1}{c}{Male} & 0.468 & 0.0002 \\ 
\multicolumn{1}{c}{amelia} & \multicolumn{1}{c}{Male} & 0.468 & 0.0001 \\ 
\multicolumn{1}{c}{mice} & \multicolumn{1}{c}{Male} & 0.468 & 0 \\ 
\multicolumn{1}{c}{na.omit} & \multicolumn{1}{c}{Male} & 0.447 & -0.021 \\ 
\multicolumn{1}{c}{true} & \multicolumn{1}{c}{interest} & 2.220 & 0 \\ 
\multicolumn{1}{c}{hd.ord} & \multicolumn{1}{c}{interest} & 2.221 & 0.002 \\ 
\multicolumn{1}{c}{hd.norm.orig} & \multicolumn{1}{c}{interest} & 2.221 & 0.002 \\ 
\multicolumn{1}{c}{amelia} & \multicolumn{1}{c}{interest} & 2.220 & 0.0001 \\ 
\multicolumn{1}{c}{mice} & \multicolumn{1}{c}{interest} & 2.220 & 0.0001 \\ 
\multicolumn{1}{c}{na.omit} & \multicolumn{1}{c}{interest} & 2.201 & -0.019 \\ 
\hline \\[-1.8ex] 
\end{tabular} 
\end{table}
...
\begin{table}[!htbp] \centering 
  \caption{Accuracy of Multiple Imputation Methods (ownNA, old framing data)} 
...
\hline \\[-1.8ex] 
\multicolumn{1}{c}{true} & \multicolumn{1}{c}{Dem} & 0.467 & 0 \\ 
\multicolumn{1}{c}{hd.ord} & \multicolumn{1}{c}{Dem} & 0.470 & 0.003 \\ 
\multicolumn{1}{c}{hd.norm.orig} & \multicolumn{1}{c}{Dem} & 0.472 & 0.006 \\ 
\multicolumn{1}{c}{amelia} & \multicolumn{1}{c}{Dem} & 0.467 & 0.0001 \\ 
\multicolumn{1}{c}{mice} & \multicolumn{1}{c}{Dem} & 0.467 & 0.0003 \\ 
\multicolumn{1}{c}{na.omit} & \multicolumn{1}{c}{Dem} & 0.467 & 0.0002 \\ 
\multicolumn{1}{c}{true} & \multicolumn{1}{c}{age} & 37.925 & 0 \\ 
\multicolumn{1}{c}{hd.ord} & \multicolumn{1}{c}{age} & 36.154 & -1.772 \\ 
\multicolumn{1}{c}{hd.norm.orig} & \multicolumn{1}{c}{age} & 35.884 & -2.041 \\ 
\multicolumn{1}{c}{amelia} & \multicolumn{1}{c}{age} & 37.925 & -0.001 \\ 
\multicolumn{1}{c}{mice} & \multicolumn{1}{c}{age} & 37.937 & 0.012 \\ 
\multicolumn{1}{c}{na.omit} & \multicolumn{1}{c}{age} & 37.922 & -0.003 \\ 
\multicolumn{1}{c}{true} & \multicolumn{1}{c}{interest} & 3.216 & 0 \\ 
\multicolumn{1}{c}{hd.ord} & \multicolumn{1}{c}{interest} & 3.116 & -0.100 \\ 
\multicolumn{1}{c}{hd.norm.orig} & \multicolumn{1}{c}{interest} & 3.101 & -0.115 \\ 
\multicolumn{1}{c}{amelia} & \multicolumn{1}{c}{interest} & 3.217 & 0.0002 \\ 
\multicolumn{1}{c}{mice} & \multicolumn{1}{c}{interest} & 3.216 & -0.001 \\ 
\multicolumn{1}{c}{na.omit} & \multicolumn{1}{c}{interest} & 3.216 & 0.0001 \\ 
\hline \\[-1.8ex] 
\end{tabular} 
\end{table}
Table \ref{ownNA.old.frame.acc} shows that method performance does not change when a different function to create NAs is applied. Note that the number of amputed and imputed variables is lower here, as my method depends on other variables to create NAs. However, it seems my method is closer to being MCAR than MAR, as \texttt{na.omit} outperforms other methods here.
...
It thus appears that \texttt{hd.ord} is getting somewhat slightly closer to the performance of \texttt{amelia} and \texttt{mice} for the \texttt{age}, \texttt{inc}, and \texttt{interest} variables when we switch from the old framing to the ANES data. This could be due to the higher number of observations and. In the case of \texttt{age} and \texttt{inc}, the higher number of unique values is also noticeable.

\hypertarget{ordmiss-results-runtimes}{%
\section{Runtimes}\label{ordmiss-results-runtimes}}

Run in R 3.6 on a Code Ocean AWS EC2 instance with 16 cores and 120 GB of memory. Amputed with \texttt{ampute}.
\begin{table}[!htbp] \centering 
...
\end{tabular} 
\end{table}
As can be seen in Table \ref{runtimes}, \texttt{hd.ord} and \texttt{hot.deck} show virtually identical imputation times for the old framing data, with \texttt{hd.ord} being 27 seconds faster. \texttt{amelia}, however, is 2 times slower than \texttt{hd.ord}. \texttt{mice} is 18 times slower than \texttt{hd.ord}. This is a dramatic speed gain. The ANES data show only a reduced speed gain. \texttt{mice} is still drastically slower than \texttt{hd.ord} (by a magnitude of 9), but the speed gain is cut in half. The previous speed gain over \texttt{amelia} is no longer observable. \texttt{hd.ord} and \texttt{amelia} now show virtually identical runtimes (with a difference of 25 seconds in favor of \texttt{hd.ord}). Note that the ANES data contain more than triple the observations than the old framing data, which reduces the number of computationally feasible overall iterations for these data.
