...
\subsection{\texorpdfstring{With Standard \texttt{ampute()}}{With Standard ampute()}}\label{ordmiss-results-acc-ampute}}
\begin{table}[!htbp] \centering 
...
These results are overall confirmed when \texttt{ampute()} is run on the 2016 ANES data (n = 3,223), as shown in Table \ref{amp.anes.acc}. It is noticeable, however, that the differences in method performance are somewhat reduced with the ANES data (n = 3,223). This is likely due to the increased number of observations in the data. For reasons of brevity, this analysis and all further analyses insert 20 percent NAs only.
\begin{table}[!htbp] \centering 
  \caption{Accuracy of Multiple Imputation Methods (ampute, ANES 2016 (n = 3,223))} 
  \label{amp.anes.acc} 
...
\hline \\[-1.8ex] 
\multicolumn{1}{c}{true} & \multicolumn{1}{c}{Dem} & \multicolumn{1}{c}{.3549} & \multicolumn{1}{c}{.0000} \\ 
\multicolumn{1}{c}{hd.ord} & \multicolumn{1}{c}{Dem} & \multicolumn{1}{c}{.3552} & \multicolumn{1}{c}{.0003} \\ 
\multicolumn{1}{c}{hd.norm} & \multicolumn{1}{c}{Dem} & \multicolumn{1}{c}{.3552} & \multicolumn{1}{c}{.0003} \\ 
\multicolumn{1}{c}{amelia} & \multicolumn{1}{c}{Dem} & \multicolumn{1}{c}{.3549} & \multicolumn{1}{c}{.0000} \\ 
\multicolumn{1}{c}{mice} & \multicolumn{1}{c}{Dem} & \multicolumn{1}{c}{.3549} & \multicolumn{1}{c}{.0000} \\ 
\multicolumn{1}{c}{na.omit} & \multicolumn{1}{c}{Dem} & \multicolumn{1}{c}{.3388} & \multicolumn{1}{c}{.0161} \\ 
\multicolumn{1}{c}{true} & \multicolumn{1}{c}{inc} & \multicolumn{1}{c}{15.5740} & \multicolumn{1}{c}{.0000} \\ 
\multicolumn{1}{c}{hd.ord} & \multicolumn{1}{c}{inc} & \multicolumn{1}{c}{15.5762} & \multicolumn{1}{c}{.0022} \\ 
\multicolumn{1}{c}{hd.norm} & \multicolumn{1}{c}{inc} & \multicolumn{1}{c}{15.5779} & \multicolumn{1}{c}{.0039} \\ 
\multicolumn{1}{c}{amelia} & \multicolumn{1}{c}{inc} & \multicolumn{1}{c}{15.5753} & \multicolumn{1}{c}{.0013} \\ 
\multicolumn{1}{c}{mice} & \multicolumn{1}{c}{inc} & \multicolumn{1}{c}{15.5755} & \multicolumn{1}{c}{.0015} \\ 
\multicolumn{1}{c}{na.omit} & \multicolumn{1}{c}{inc} & \multicolumn{1}{c}{15.2306} & \multicolumn{1}{c}{.3434} \\ 
\multicolumn{1}{c}{true} & \multicolumn{1}{c}{age} & \multicolumn{1}{c}{49.0400} & \multicolumn{1}{c}{.0000} \\ 
\multicolumn{1}{c}{hd.ord} & \multicolumn{1}{c}{age} & \multicolumn{1}{c}{49.0075} & \multicolumn{1}{c}{.0325} \\ 
\multicolumn{1}{c}{hd.norm} & \multicolumn{1}{c}{age} & \multicolumn{1}{c}{49.0157} & \multicolumn{1}{c}{.0243} \\ 
\multicolumn{1}{c}{amelia} & \multicolumn{1}{c}{age} & \multicolumn{1}{c}{49.0384} & \multicolumn{1}{c}{.0016} \\ 
\multicolumn{1}{c}{mice} & \multicolumn{1}{c}{age} & \multicolumn{1}{c}{49.0385} & \multicolumn{1}{c}{.0015} \\ 
\multicolumn{1}{c}{na.omit} & \multicolumn{1}{c}{age} & \multicolumn{1}{c}{48.3780} & \multicolumn{1}{c}{.6620} \\ 
\multicolumn{1}{c}{true} & \multicolumn{1}{c}{Female} & \multicolumn{1}{c}{.4682} & \multicolumn{1}{c}{.0000} \\ 
\multicolumn{1}{c}{hd.ord} & \multicolumn{1}{c}{Female} & \multicolumn{1}{c}{.4684} & \multicolumn{1}{c}{.0002} \\ 
\multicolumn{1}{c}{hd.norm} & \multicolumn{1}{c}{Female} & \multicolumn{1}{c}{.4684} & \multicolumn{1}{c}{.0002} \\ 
\multicolumn{1}{c}{amelia} & \multicolumn{1}{c}{Female} & \multicolumn{1}{c}{.4683} & \multicolumn{1}{c}{.0001} \\ 
\multicolumn{1}{c}{mice} & \multicolumn{1}{c}{Female} & \multicolumn{1}{c}{.4682} & \multicolumn{1}{c}{.0000} \\ 
\multicolumn{1}{c}{na.omit} & \multicolumn{1}{c}{Female} & \multicolumn{1}{c}{.4470} & \multicolumn{1}{c}{.0212} \\ 
\multicolumn{1}{c}{true} & \multicolumn{1}{c}{interest} & \multicolumn{1}{c}{2.2197} & \multicolumn{1}{c}{.0000} \\ 
\multicolumn{1}{c}{hd.ord} & \multicolumn{1}{c}{interest} & \multicolumn{1}{c}{2.2213} & \multicolumn{1}{c}{.0016} \\ 
\multicolumn{1}{c}{hd.norm} & \multicolumn{1}{c}{interest} & \multicolumn{1}{c}{2.2213} & \multicolumn{1}{c}{.0016} \\ 
\multicolumn{1}{c}{amelia} & \multicolumn{1}{c}{interest} & \multicolumn{1}{c}{2.2198} & \multicolumn{1}{c}{.0001} \\ 
\multicolumn{1}{c}{mice} & \multicolumn{1}{c}{interest} & \multicolumn{1}{c}{2.2198} & \multicolumn{1}{c}{.0001} \\ 
\multicolumn{1}{c}{na.omit} & \multicolumn{1}{c}{interest} & \multicolumn{1}{c}{2.2009} & \multicolumn{1}{c}{.0188} \\ 
\hline \\[-1.8ex] 
\end{tabular} 
\end{table}
\hypertarget{ordmiss-results-acc-ampute-mod}{%
\subsection{\texorpdfstring{With Modified \texttt{ampute()}}{With Modified ampute()}}\label{ordmiss-results-acc-ampute-mod}}

Table \ref{amp.oldframe.bycases.acc} shows the results of using \texttt{ampute()} with the options \texttt{bycases=FALSE} and \texttt{cont=FALSE} on the old framing data (n = 1,003). \texttt{hd.ord} overall performs worse than the analyses presented in Tables \ref{amp.oldframe.acc} and \ref{amp.anes.acc} above.
\begin{table}[!htbp] \centering 
  \caption{Accuracy of Multiple Imputation Methods (ampute with bycases, old framing data (n = 1,003))} 
