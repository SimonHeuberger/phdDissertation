...
\caption{\label{fig:Barplot-Education-Categories}Distribution of Education Categories. Original ANES Categories on the Left, Ordered Probit Estimated Categories on the Right. Categories Below \texttt{High\ School\ Graduate} and Above \texttt{Master\textquotesingle{}s} Are Collapsed. OP Categories Can Now Be Used For Blocking.\label{BarEducCat}}
\end{figure}
...
The ANOVA regression is repeated for each of the three data sets. Tables \ref{aov-sum} shows a summary of the results. Almost all variable intercepts do not show statistical significance. An exception here is treatment group 2, which shows a \(p\)-value of .017 for \texttt{Feel\ Trump}. Overall, however, the differences between the treatment group means of \texttt{Age} and \texttt{Feel\ Trump} are not statistically significant for this sample size, i.e.~blocking on two different sets of education categories does not result in significantly differing means for the numerical variables.\footnote{For a similar analysis of the non-numerical factor variables (a binomial GLM regression), see appendix Table \ref{glm-sum}).}
\begin{table}[!htbp] \centering  
...
\textbf{Gender} & & & & \\  
 ...
 T2 & -0.004 & .087 & -0.044 & .965 \\
 T3 Intercept & .134 & .062 & 2.159 & .031 \\
 T3 & -0.034 & .087 & -0.393 & .694 \\ 
 & & & & \\  
\textbf{Race} & & & & \\  
 T1 Intercept & -1.061 & .071 & -15.024 & .000 \\
 T1 & -0.035 & .100 & -0.351 & .726 \\ 
 T2 Intercept & -1.153 & .072 & -15.952 & .000 \\
 T2 & .041 & .102 & .407 & .684 \\
 T3 Intercept & -1.206 & .073 & -16.452 & .000 \\
 T3 & -0.005 & .104 & -0.052 & .959 \\
   & & & & \\  
\textbf{Income} & & & & \\  
 T1 Intercept & 1.334 & .076 & 17.557 & .000 \\
 T1 & -0.006 & .107 & -0.054 & .957 \\
 T2 Intercept & 1.227 & .074 & 16.649 & .000 \\ 
 T2 & .038 & .105 & .367 & .714 \\ 
 T3 Intercept & 1.398 & .077 & 18.058 & .000 \\ 
 T3 & -0.036 & .109 & -0.327 & .744 \\
 & & & & \\  
\textbf{Employment} & & & & \\  
 T1 Intercept & -0.421 & .063 & -6.678 & .000 \\
 T1 & -0.246 & .091 & -2.713 & .007 \\
 T2 Intercept & -0.567 & .064 & -8.831 & .000 \\
 T2 & .193 & .090 & 2.152 & .031 \\
 T3 Intercept & -0.588 & .064 & -9.126 & .000 \\ 
 T3 & .049 & .091 & .545 & .586 \\ 
 & & & & \\  
  \textbf{Party ID} & & & & \\  
 ...
 T2 & -0.125 & .091 & -1.367 & .172 \\
 T3 Intercept & .609 & .065 & 9.421 & .000 \\ 
 T3 & -0.000 & .091 & -0.000 & 1.000 \\ 
 & & & & \\  
\textbf{President} & & & & \\  
 T1 Intercept & -0.210 & .062 & -3.388 & .001 \\ 
 T1 & .058 & .088 & .657 & .511 \\ 
 T2 Intercept & -0.008 & .062 & -0.123 & .902 \\ 
 T2 & -0.134 & .087 & -1.528 & .126 \\ 
 T3 Intercept & -0.103 & .062 & -1.666 & .096 \\
 T3 & .076 & .087 & .873 & .383 \\ 
 & & & & \\  
\textbf{Minimum Wage} & & & & \\  
 T1 Intercept & -0.613 & .065 & -9.480 & .000 \\ 
 T1 & .042 & .091 & .456 & .649 \\ 
 T2 Intercept & -0.465 & .063 & -7.340 & .000 \\
 T2 & -0.106 & .090 & -1.173 & .241 \\
 T3 Intercept & -0.685 & .065 & -10.472 & .000 \\ 
 T3 & .068 & .092 & .736 & .462 \\
 & & & & \\  
\textbf{Country} & & & & \\  
 T1 Intercept & .954 & .069 & 13.850 & .000 \\ 
 T1 & -0.005 & .097 & -0.049 & .961 \\ 
 T2 Intercept & 1.111 & .071 & 15.544 & .000 \\ 
 T2 & -0.055 & .100 & -0.552 & .581 \\ 
...
\\[-1.8ex] & \multicolumn{2}{c}{Healthcare} & \multicolumn{2}{c}{Environment} \\ 
 & \multicolumn{1}{c}{ANES} & \multicolumn{1}{c}{OP} & \multicolumn{1}{c}{ANES} & \multicolumn{1}{c}{OP} \\ 
\hline \\[-1.8ex] 
 Moral opposing & -0.261$ $(-1.013$, $.490) & -0.732^{}$ $(-1.397$, $-.067) & -1.009^{}$ $(-1.711$, $-.306) & -0.088$ $(-.706$, $.531) \\ 
  Moral supporting & 0.131$ $(-.586$, $.847) & -0.471$ $(-1.130$, $.189) & -0.304$ $(-1.034$, $.425) & -0.190$ $(-.832$, $.452) \\ 
  Self-interest opposing & -0.699^{}$ $(-1.370$, $-.028) & -0.949^{}$ $(-1.603$, $-.296) & -0.343$ $(-1.026$, $.340) & 0.027$ $(-.567$, $.622) \\ 
  Self-interest supporting & -0.302$ $(-1.005$, $.401) & -0.325$ $(-.948$, $.298) & 0.063$ $(-.591$, $.716) & 0.258$ $(-.360$, $.876) \\ 
  Employed full time & 0.222$ $(-.743$, $1.188) & -0.114$ $(-.832$, $.604) & -0.222$ $(-1.150$, $.707) & 0.137$ $(-.608$, $.882) \\ 
  Employed part time & 0.224$ $(-.828$, $1.276) & -0.337$ $(-1.145$, $.472) & -0.142$ $(-1.153$, $.869) & 0.204$ $(-.624$, $1.032) \\ 
  Homemaker & -0.048$ $(-1.168$, $1.072) & -0.310$ $(-1.285$, $.664) & -0.006$ $(-1.116$, $1.103) & 0.109$ $(-.911$, $1.130) \\ 
  Retired & -0.340$ $(-1.323$, $.643) & -0.427$ $(-1.187$, $.334) & -0.275$ $(-1.225$, $.675) & 0.007$ $(-.782$, $.796) \\ 
  Student & 1.285$ $(-.353$, $2.922) & 0.147$ $(-.931$, $1.225) & -0.103$ $(-1.677$, $1.472) & -0.885$ $(-2.008$, $.239) \\ 
  Income & -0.006$ $(-.149$, $.137) & -0.105^{}$ $(-.227$, $.018) & 0.070$ $(-.070$, $.209) & 0.054$ $(-.066$, $.174) \\ 
  Male & -0.141$ $(-.578$, $.295) & 0.072$ $(-.344$, $.488) & -0.147$ $(-.587$, $.293) & -0.244$ $(-.671$, $.183) \\ 
  5th-6th grade & -2.747^{}$ $(-5.811$, $.317) &  & 0.288$ $(-2.255$, $2.831) &  \\ 
  7th-8th grade & 0.821$ $(-2.644$, $4.286) &  & 2.312$ $(-.990$, $5.615) &  \\ 
  ...
  High school graduate & 0.036$ $(-1.515$, $1.587) &  & 1.158^{}$ $(-.205$, $2.521) &  \\ 
  Some college & -0.341$ $(-1.888$, $1.206) & -0.165$ $(-.744$, $.413) & 1.160^{}$ $(-.207$, $2.527) & 0.352$ $(-.240$, $.943) \\ 
  Associate degree & -0.626$ $(-2.207$, $.955) & -0.209$ $(-.872$, $.453) & 0.739$ $(-.666$, $2.145) & -0.152$ $(-.818$, $.514) \\ 
  Bachelor & -0.495$ $(-2.018$, $1.029) & 0.122$ $(-.489$, $.733) & 1.224^{}$ $(-.111$, $2.559) & -0.262$ $(-.880$, $.356) \\ 
  Master & -1.154$ $(-2.772$, $.465) &  & 0.868$ $(-.564$, $2.300) &  \\ 
  Professional degree & -1.146$ $(-3.198$, $.906) &  & 0.658$ $(-1.457$, $2.772) &  \\ 
  Master or higher &  & -0.117$ $(-.819$, $.586) &  & -0.097$ $(-.814$, $.619) \\ 
 \hline \\[-1.8ex] 
...
\\[-1.8ex] & \multicolumn{2}{c}{Healthcare} & \multicolumn{2}{c}{Environment} \\ 
 & \multicolumn{1}{c}{ANES} & \multicolumn{1}{c}{OP} & \multicolumn{1}{c}{ANES} & \multicolumn{1}{c}{OP} \\ 
\hline \\[-1.8ex] 
 Moral opposing & -0.304$ $(-.890$, $.283) & -0.781^{}$ $(-1.363$, $-.199) & -0.676^{}$ $(-1.317$, $-.036) & -0.671^{}$ $(-1.225$, $-.116) \\ 
  Moral supporting & 0.415$ $(-.167$, $.997) & -0.310$ $(-.871$, $.252) & -0.110$ $(-.733$, $.514) & -0.591^{}$ $(-1.159$, $-.022) \\ 
  Self-interest opposing & -0.042$ $(-.574$, $.490) & -0.136$ $(-.712$, $.440) & -0.145$ $(-.763$, $.474) & -0.513^{}$ $(-1.081$, $.054) \\ 
  Self-interest supporting & -0.073$ $(-.664$, $.517) & -0.135$ $(-.688$, $.419) & 0.497^{}$ $(-.085$, $1.079) & -0.559^{}$ $(-1.138$, $.019) \\ 
  Employed full time & 0.010$ $(-.634$, $.653) & -0.027$ $(-.641$, $.586) & -0.296$ $(-.950$, $.358) & 0.229$ $(-.378$, $.835) \\ 
  Employed part time & 0.113$ $(-.586$, $.813) & -0.079$ $(-.748$, $.591) & -0.403$ $(-1.115$, $.309) & -0.027$ $(-.690$, $.636) \\ 
  Homemaker & 0.469$ $(-.552$, $1.490) & 0.132$ $(-.808$, $1.072) & 0.271$ $(-.772$, $1.315) & -0.199$ $(-1.110$, $.711) \\ 
  Retired & 0.171$ $(-.497$, $.839) & 0.505$ $(-.158$, $1.169) & 0.085$ $(-.584$, $.754) & 0.895^{}$ $(.234$, $1.557) \\ 
  Student & -0.257$ $(-1.303$, $.789) & -0.288$ $(-1.237$, $.662) & -0.838$ $(-1.926$, $.250) & 0.510$ $(-.458$, $1.479) \\ 
  Income & -0.026$ $(-.138$, $.085) & -0.052$ $(-.166$, $.061) & -0.024$ $(-.139$, $.091) & 0.049$ $(-.064$, $.162) \\ 
  Male & 0.006$ $(-.380$, $.392) & 0.092$ $(-.282$, $.465) & -0.108$ $(-.491$, $.275) & -0.175$ $(-.551$, $.200) \\ 
  1st-4th grade & 19.675^{}$ $(17.269$, $22.080) &  & 0.217$ $(-4.350$, $4.785) &  \\ 
  7th-8th grade & 0.525^{}$ $(.525$, $.525) &  & -15.604^{}$ $(-15.604$, $-15.604) &  \\ 
  ...
  Some college & 23.051^{}$ $(22.499$, $23.603) & 0.566^{}$ $(.004$, $1.129) & 1.217$ $(-2.767$, $5.201) & 0.207$ $(-.350$, $.764) \\ 
  Associate degree & 23.238^{}$ $(22.583$, $23.894) & 0.402$ $(-.231$, $1.034) & 1.483$ $(-2.517$, $5.483) & 0.365$ $(-.280$, $1.009) \\ 
  Bachelor & 23.384^{}$ $(22.841$, $23.926) & 0.213$ $(-.334$, $.760) & 1.745$ $(-2.226$, $5.717) & 0.019$ $(-.547$, $.585) \\ 
  ...
  Master or higher &  & 0.694^{}$ $(.060$, $1.328) &  & -0.058$ $(-.677$, $.562) \\ 
 \hline \\[-1.8ex] 
