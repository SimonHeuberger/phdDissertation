...
\begin{figure}
\centering
\includegraphics{dissertation_files/figure-latex/Speed-Plots-20-Percent-1.pdf}
\caption{\label{fig:Speed-Plots-20-Percent}Accuracy of Multiple Imputation Methods for 20 Percent Missingness. CCES Data, MAR, Five Variables with NA. Y-Axis Shows Percentages/Means.\label{Speed20}}
\end{figure}
\begin{figure}
\centering
\includegraphics{dissertation_files/figure-latex/Speed-Plots-50-Percent-1.pdf}
\caption{\label{fig:Speed-Plots-50-Percent}Accuracy of Multiple Imputation Methods for 50 Percent Missingness. CCES Data, MAR, Five Variables with NA. Y-Axis Shows Percentages/Means.\label{Speed50}}
\end{figure}
